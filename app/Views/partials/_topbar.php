  ...
  <div class="flex items-center gap-2 flex-shrink-0">
    ...
    <div class="relative">
      ...
      >
        ...
        <!-- Unread badge -->
        <span class="absolute top-[7px] right-[8px] w-2 h-2 bg-red-500 rounded-full border-2 border-white"></span>
      </button>
      ...
      >
        ...
        <div class="flex items-center justify-between px-4 py-3.5 border-b border-neutral-100">
          ...
          <a href="<?= url('/notifications/mark-read') ?>" class="text-xs font-medium text-[#00A486] hover:underline">Mark all as read</a>
        </div>

        <!-- List -->
        <ul id="notif-list" role="list">
          <li class="flex gap-3 px-4 py-3 hover:bg-neutral-50 cursor-pointer border-b border-neutral-50 transition-colors">
            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-[#00B795]"></span>
            <div>
              <p class="text-[13px] text-neutral-700 leading-snug"><strong class="font-semibold text-neutral-900">Karim Ahmed</strong> submitted a new article for review.</p>
          ...
          <li class="flex gap-3 px-4 py-3 hover:bg-neutral-50 cursor-pointer border-b border-neutral-50 transition-colors">
            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-[#00B795]"></span>
            <div>
              <p class="text-[13px] text-neutral-700 leading-snug">Your article <strong class="font-semibold text-neutral-900">"Climate &amp; Economy"</strong> was published.</p>
          ...
          <li class="flex gap-3 px-4 py-3 hover:bg-neutral-50 cursor-pointer border-b border-neutral-50 transition-colors">
            ...
            <div>
              <p class="text-[13px] text-neutral-700 leading-snug"><strong class="font-semibold text-neutral-900">Admin</strong> left a comment on your draft.</p>
          ...
          <li class="flex gap-3 px-4 py-3 hover:bg-neutral-50 cursor-pointer transition-colors">
            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-neutral-300"></span>
            <div>
              <p class="text-[13px] text-neutral-700 leading-snug">System maintenance scheduled for <strong class="font-semibold text-neutral-900">Sunday 2 AM</strong>.</p>
        ...
        <div class="px-4 py-2.5 border-t border-neutral-100 text-center">
          <a href="<?= url('/notifications') ?>" class="text-xs font-medium text-[#00A486] hover:underline">View all notifications</a>
        </div>
      </div>
    </div>
    ...
    <div class="relative">
      ...
      >
        <!-- Avatar -->
        <div
          class="w-[38px] h-[38px] rounded-[10px] flex items-center justify-center text-white text-sm font-bold flex-shrink-0 tracking-wide"
      ...
      >
        ...
        >
          <span class="w-7 h-7 rounded-[7px] bg-red-50 text-red-600 flex items-center justify-center text-[13px] flex-shrink-0">
